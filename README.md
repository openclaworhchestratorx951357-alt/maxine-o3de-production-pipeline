...
- Command-pack admission precheck report v1 is integrated as a static pre-admission classification layer; it keeps all command admission, runner, dry-run execution, receipt issuance, publication, and production-ready claims blocked while classifying static, blocked, and refused command categories.
