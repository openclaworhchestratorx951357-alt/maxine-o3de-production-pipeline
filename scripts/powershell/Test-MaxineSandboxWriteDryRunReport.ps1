param(
    [string]$ReportPath = "examples/manifests/example-sandbox-write-dry-run-report.json"
)
...
$auditScript = Join-Path $repoRoot "tools\audit\verify_sandbox_write_dry_run_report.py"
