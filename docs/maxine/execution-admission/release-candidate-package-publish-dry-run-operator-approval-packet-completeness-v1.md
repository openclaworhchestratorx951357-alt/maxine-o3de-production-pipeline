...
An explicit static non-approval decision record now captures the active decision state for this blocked posture:
...
The decision remains `do_not_approve`, with next action `continue_hardening_no_execution`.
