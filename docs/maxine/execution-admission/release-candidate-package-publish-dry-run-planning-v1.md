...
The operator packet now also has a static completeness self-check:
...
This keeps `selected_operator_decision=do_not_approve` and `next_recommended_action=continue_hardening_no_execution`.
