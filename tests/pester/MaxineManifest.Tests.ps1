Describe "Maxine Manifest Repository Baseline" {
    ...
    It "has sandbox implementation explicit execution-authorization decision doc" {
        Test-Path -LiteralPath "docs/reviews/SANDBOX-IMPLEMENTATION-EXPLICIT-EXECUTION-AUTHORIZATION-DECISION.md" | Should Be $true
    }

    It "has sandbox implementation explicit execution-authorization decision JSON" {
        Test-Path -LiteralPath "docs/reviews/sandbox_implementation_explicit_execution_authorization_decision.json" | Should Be $true
    }

    It "has sandbox implementation explicit execution-authorization decision verifier" {
        Test-Path -LiteralPath "tools/audit/verify_sandbox_implementation_explicit_execution_authorization_decision.py" | Should Be $true
    }

    It "has sandbox implementation explicit execution-authorization decision PowerShell wrapper" {
