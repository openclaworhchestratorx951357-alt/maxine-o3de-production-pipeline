...
def test_invoke_sandbox_write_admitted_under_safety_contract_for_execution_readiness_authorization_decision_phase():
    repo_root = Path(__file__).resolve().parents[2]
...
def test_invoke_sandbox_rollback_admitted_under_safety_contract_for_execution_readiness_authorization_decision_phase():
    repo_root = Path(__file__).resolve().parents[2]
