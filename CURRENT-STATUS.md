...
- Verify Active Editor Viewport / Temp Visual Scene Readiness v1 is implemented on `codex/verify-active-editor-viewport-temp-visual-scene-readiness-v1` and pending review:
