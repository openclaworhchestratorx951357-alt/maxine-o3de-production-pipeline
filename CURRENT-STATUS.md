...
- Pin Approved Runtime Character Spawnable Surface v1 is in progress on `codex/pin-approved-runtime-character-spawnable-surface-v1`:
  - PR #139 was merged into `main` at `967f2260d69c951756c0e5fed63dde35a4176baf`, and this branch was created from updated `main`
  - this slice adds `--diagnose-runtime-character-spawnable-surface` to `tools/o3de/runtime_harness.py` as a read-only source/APB/AP DB diagnostic for the approved runtime-equivalent character surface required by PR #139
