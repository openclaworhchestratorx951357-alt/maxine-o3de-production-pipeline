...
def _fixture_env(env: Mapping[str, str]) -> Dict[str, str]:
    ...
    for key in (
        ...
        "MAXINE_ALLOW_RUNTIME_FIXTURE_TEMP_REGISTRY_PATCH",
        "MAXINE_ALLOW_RUNTIME_FIXTURE_TEMP_LEVEL",
        "MAXINE_ALLOW_RUNTIME_FIXTURE_CACHE_BOOTSTRAP_REFRESH",
        "MAXINE_ALLOW_RUNTIME_FIXTURE_CACHE_BOOTSTRAP_MUTATION",
        "MAXINE_ALLOW_RUNTIME_FIXTURE_ASSET_PROCESSOR_SESSION",
        "MAXINE_ENABLE_RUNTIME_CHARACTER_PRODUCT_LOAD_PROBE",
        "MAXINE_ENABLE_RUNTIME_CHARACTER_SPAWNABLE_SURFACE",
        "MAXINE_ENABLE_RUNTIME_CHARACTER_SPAWN_INSTANTIATION",
        "MAXINE_ALLOW_RUNTIME_CHARACTER_SPAWN_INSTANTIATION",
