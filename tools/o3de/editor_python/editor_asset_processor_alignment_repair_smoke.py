#!/usr/bin/env python3
"""Run the Asset Processor project/build-root alignment repair smoke."""
...
def main() -> int:
    os.environ["MAXINE_EDITOR_SMOKE_DIAGNOSTIC_MODE"] = "asset-processor-project-build-alignment-repair"
